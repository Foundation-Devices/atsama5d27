...
pub const HW_EVENT_SOURCE0_BASE: usize = 0xf0026000;
pub const HW_EVENT_SOURCE1_BASE: usize = 0xf0027000;
pub const HW_EVENT_SOURCE2_BASE: usize = 0xf0028000;
pub const HW_EVENT_SOURCE3_BASE: usize = 0xf0029000;
pub const HW_EVENT_SOURCE4_BASE: usize = 0xf002a000;
pub const HW_PERFCOUNTER_BASE: usize = 0xf002b000;
pub const HW_IDENTIFIER_MEM_BASE: usize = 0xf002c000;
...
pub mod utra {
    ...
    pub mod crg {
        ...
        pub const MMCM_DRP_RESET_MMCM_DRP_RESET: crate::Field =
            crate::Field::new(1, 0, MMCM_DRP_RESET);

        pub const MMCM_DRP_LOCKED: crate::Register = crate::Register::new(1, 0x1);
        pub const MMCM_DRP_LOCKED_MMCM_DRP_LOCKED: crate::Field =
            crate::Field::new(1, 0, MMCM_DRP_LOCKED);

        pub const MMCM_DRP_READ: crate::Register = crate::Register::new(2, 0x1);
        pub const MMCM_DRP_READ_MMCM_DRP_READ: crate::Field =
            crate::Field::new(1, 0, MMCM_DRP_READ);

        pub const MMCM_DRP_WRITE: crate::Register = crate::Register::new(3, 0x1);
        pub const MMCM_DRP_WRITE_MMCM_DRP_WRITE: crate::Field =
            crate::Field::new(1, 0, MMCM_DRP_WRITE);

        pub const MMCM_DRP_DRDY: crate::Register = crate::Register::new(4, 0x1);
        pub const MMCM_DRP_DRDY_MMCM_DRP_DRDY: crate::Field =
            crate::Field::new(1, 0, MMCM_DRP_DRDY);
        ...
        pub const MMCM_DRP_DAT_W_MMCM_DRP_DAT_W: crate::Field =
            crate::Field::new(16, 0, MMCM_DRP_DAT_W);

        pub const MMCM_DRP_DAT_R: crate::Register = crate::Register::new(7, 0xffff);
        pub const MMCM_DRP_DAT_R_MMCM_DRP_DAT_R: crate::Field =
            crate::Field::new(16, 0, MMCM_DRP_DAT_R);
    ...
    pub mod event_source0 {
        // this enum is vestigal, and currently not used by anything
        #[derive(Debug, Copy, Clone)]
        pub enum EventSource0Offset {
            Perfevent = 0,
        }
        pub const EVENT_SOURCE0_NUMREGS: usize = 1;

        pub const PERFEVENT: crate::Register = crate::Register::new(0, 0xffffffff);
        pub const PERFEVENT_CODE: crate::Field = crate::Field::new(32, 0, PERFEVENT);

        pub const HW_EVENT_SOURCE0_BASE: usize = 0xf0026000;
    }

    pub mod event_source1 {
        // this enum is vestigal, and currently not used by anything
        #[derive(Debug, Copy, Clone)]
        pub enum EventSource1Offset {
            Perfevent = 0,
        }
        pub const EVENT_SOURCE1_NUMREGS: usize = 1;
    ...
    pub mod event_source2 {
        // this enum is vestigal, and currently not used by anything
        #[derive(Debug, Copy, Clone)]
        pub enum EventSource2Offset {
            Perfevent = 0,
        }
        pub const EVENT_SOURCE2_NUMREGS: usize = 1;
    ...
    pub mod event_source3 {
        // this enum is vestigal, and currently not used by anything
        #[derive(Debug, Copy, Clone)]
        pub enum EventSource3Offset {
            Perfevent = 0,
        }
        pub const EVENT_SOURCE3_NUMREGS: usize = 1;
    ...
    pub mod event_source4 {
        // this enum is vestigal, and currently not used by anything
        #[derive(Debug, Copy, Clone)]
        pub enum EventSource4Offset {
            Perfevent = 0,
        }
        pub const EVENT_SOURCE4_NUMREGS: usize = 1;
    ...
    pub mod perfcounter {
        ...
        pub const CONFIG: crate::Register = crate::Register::new(0, 0x3fffff);
        pub const CONFIG_PRESCALER: crate::Field = crate::Field::new(16, 0, CONFIG);
        pub const CONFIG_SATURATE: crate::Field = crate::Field::new(1, 16, CONFIG);
        pub const CONFIG_EVENT_WIDTH_MINUS_ONE: crate::Field = crate::Field::new(5, 17, CONFIG);

        pub const SATURATE_LIMIT1: crate::Register = crate::Register::new(1, 0xffffffff);
        pub const SATURATE_LIMIT1_SATURATE_LIMIT: crate::Field =
            crate::Field::new(32, 0, SATURATE_LIMIT1);

        pub const SATURATE_LIMIT0: crate::Register = crate::Register::new(2, 0xffffffff);
        pub const SATURATE_LIMIT0_SATURATE_LIMIT: crate::Field =
            crate::Field::new(32, 0, SATURATE_LIMIT0);

        pub const RUN: crate::Register = crate::Register::new(3, 0x3);
        pub const RUN_RESET_RUN: crate::Field = crate::Field::new(1, 0, RUN);
        pub const RUN_STOP: crate::Field = crate::Field::new(1, 1, RUN);

        pub const STATUS: crate::Register = crate::Register::new(4, 0xf);
        pub const STATUS_RUNNING: crate::Field = crate::Field::new(1, 0, STATUS);
        pub const STATUS_OVERFLOW: crate::Field = crate::Field::new(1, 1, STATUS);
        pub const STATUS_READABLE: crate::Field = crate::Field::new(1, 2, STATUS);
        pub const STATUS_FULL: crate::Field = crate::Field::new(1, 3, STATUS);

        pub const EVENT_INDEX: crate::Register = crate::Register::new(5, 0xfff);
        pub const EVENT_INDEX_INDEX: crate::Field = crate::Field::new(12, 0, EVENT_INDEX);

        pub const EVENT_RAW1: crate::Register = crate::Register::new(6, 0xffffffff);
        pub const EVENT_RAW1_TIMESTAMP: crate::Field = crate::Field::new(32, 0, EVENT_RAW1);

        pub const EVENT_RAW0: crate::Register = crate::Register::new(7, 0xffffffff);
        pub const EVENT_RAW0_TIMESTAMP: crate::Field = crate::Field::new(32, 0, EVENT_RAW0);
    ...
    pub mod identifier_mem {
        ...
        pub const IDENTIFIER_MEM_IDENTIFIER_MEM: crate::Field =
            crate::Field::new(8, 0, IDENTIFIER_MEM);
...
mod tests {
    ...
    fn compile_check_event_source0_csr() {
        ...
        let bar = event_source0_csr.rf(utra::event_source0::PERFEVENT_CODE);
        event_source0_csr.rmwf(utra::event_source0::PERFEVENT_CODE, bar);
    ...
    fn compile_check_event_source1_csr() {
        ...
        let bar = event_source1_csr.rf(utra::event_source1::PERFEVENT_CODE);
        event_source1_csr.rmwf(utra::event_source1::PERFEVENT_CODE, bar);
    ...
    fn compile_check_event_source2_csr() {
        ...
        let bar = event_source2_csr.rf(utra::event_source2::PERFEVENT_CODE);
        event_source2_csr.rmwf(utra::event_source2::PERFEVENT_CODE, bar);
    ...
    fn compile_check_event_source3_csr() {
        ...
        let bar = event_source3_csr.rf(utra::event_source3::PERFEVENT_CODE);
        event_source3_csr.rmwf(utra::event_source3::PERFEVENT_CODE, bar);
    ...
    fn compile_check_event_source4_csr() {
        ...
        let bar = event_source4_csr.rf(utra::event_source4::PERFEVENT_CODE);
        event_source4_csr.rmwf(utra::event_source4::PERFEVENT_CODE, bar);
    ...
    fn compile_check_perfcounter_csr() {
        ...
        let bar = perfcounter_csr.rf(utra::perfcounter::CONFIG_PRESCALER);
        perfcounter_csr.rmwf(utra::perfcounter::CONFIG_PRESCALER, bar);
        let mut baz = perfcounter_csr.zf(utra::perfcounter::CONFIG_PRESCALER, bar);
        baz |= perfcounter_csr.ms(utra::perfcounter::CONFIG_PRESCALER, 1);
        perfcounter_csr.wfo(utra::perfcounter::CONFIG_PRESCALER, baz);
        let bar = perfcounter_csr.rf(utra::perfcounter::CONFIG_SATURATE);
        perfcounter_csr.rmwf(utra::perfcounter::CONFIG_SATURATE, bar);
        let mut baz = perfcounter_csr.zf(utra::perfcounter::CONFIG_SATURATE, bar);
        baz |= perfcounter_csr.ms(utra::perfcounter::CONFIG_SATURATE, 1);
        perfcounter_csr.wfo(utra::perfcounter::CONFIG_SATURATE, baz);
        let bar = perfcounter_csr.rf(utra::perfcounter::CONFIG_EVENT_WIDTH_MINUS_ONE);
        perfcounter_csr.rmwf(utra::perfcounter::CONFIG_EVENT_WIDTH_MINUS_ONE, bar);
        let mut baz = perfcounter_csr.zf(utra::perfcounter::CONFIG_EVENT_WIDTH_MINUS_ONE, bar);
        baz |= perfcounter_csr.ms(utra::perfcounter::CONFIG_EVENT_WIDTH_MINUS_ONE, 1);
        perfcounter_csr.wfo(utra::perfcounter::CONFIG_EVENT_WIDTH_MINUS_ONE, baz);

        let foo = perfcounter_csr.r(utra::perfcounter::SATURATE_LIMIT1);
        perfcounter_csr.wo(utra::perfcounter::SATURATE_LIMIT1, foo);
        let bar = perfcounter_csr.rf(utra::perfcounter::SATURATE_LIMIT1_SATURATE_LIMIT);
        perfcounter_csr.rmwf(utra::perfcounter::SATURATE_LIMIT1_SATURATE_LIMIT, bar);
        let mut baz = perfcounter_csr.zf(utra::perfcounter::SATURATE_LIMIT1_SATURATE_LIMIT, bar);
        baz |= perfcounter_csr.ms(utra::perfcounter::SATURATE_LIMIT1_SATURATE_LIMIT, 1);
        perfcounter_csr.wfo(utra::perfcounter::SATURATE_LIMIT1_SATURATE_LIMIT, baz);

        let foo = perfcounter_csr.r(utra::perfcounter::SATURATE_LIMIT0);
        perfcounter_csr.wo(utra::perfcounter::SATURATE_LIMIT0, foo);
        let bar = perfcounter_csr.rf(utra::perfcounter::SATURATE_LIMIT0_SATURATE_LIMIT);
        perfcounter_csr.rmwf(utra::perfcounter::SATURATE_LIMIT0_SATURATE_LIMIT, bar);
        let mut baz = perfcounter_csr.zf(utra::perfcounter::SATURATE_LIMIT0_SATURATE_LIMIT, bar);
        baz |= perfcounter_csr.ms(utra::perfcounter::SATURATE_LIMIT0_SATURATE_LIMIT, 1);
        perfcounter_csr.wfo(utra::perfcounter::SATURATE_LIMIT0_SATURATE_LIMIT, baz);

        let foo = perfcounter_csr.r(utra::perfcounter::RUN);
        perfcounter_csr.wo(utra::perfcounter::RUN, foo);
        let bar = perfcounter_csr.rf(utra::perfcounter::RUN_RESET_RUN);
        perfcounter_csr.rmwf(utra::perfcounter::RUN_RESET_RUN, bar);
        let mut baz = perfcounter_csr.zf(utra::perfcounter::RUN_RESET_RUN, bar);
        baz |= perfcounter_csr.ms(utra::perfcounter::RUN_RESET_RUN, 1);
        perfcounter_csr.wfo(utra::perfcounter::RUN_RESET_RUN, baz);
        let bar = perfcounter_csr.rf(utra::perfcounter::RUN_STOP);
        perfcounter_csr.rmwf(utra::perfcounter::RUN_STOP, bar);
        let mut baz = perfcounter_csr.zf(utra::perfcounter::RUN_STOP, bar);
        baz |= perfcounter_csr.ms(utra::perfcounter::RUN_STOP, 1);
        perfcounter_csr.wfo(utra::perfcounter::RUN_STOP, baz);

        let foo = perfcounter_csr.r(utra::perfcounter::STATUS);
        perfcounter_csr.wo(utra::perfcounter::STATUS, foo);
        let bar = perfcounter_csr.rf(utra::perfcounter::STATUS_RUNNING);
        perfcounter_csr.rmwf(utra::perfcounter::STATUS_RUNNING, bar);
        let mut baz = perfcounter_csr.zf(utra::perfcounter::STATUS_RUNNING, bar);
        baz |= perfcounter_csr.ms(utra::perfcounter::STATUS_RUNNING, 1);
        perfcounter_csr.wfo(utra::perfcounter::STATUS_RUNNING, baz);
        let bar = perfcounter_csr.rf(utra::perfcounter::STATUS_OVERFLOW);
        perfcounter_csr.rmwf(utra::perfcounter::STATUS_OVERFLOW, bar);
        let mut baz = perfcounter_csr.zf(utra::perfcounter::STATUS_OVERFLOW, bar);
        baz |= perfcounter_csr.ms(utra::perfcounter::STATUS_OVERFLOW, 1);
        perfcounter_csr.wfo(utra::perfcounter::STATUS_OVERFLOW, baz);
        let bar = perfcounter_csr.rf(utra::perfcounter::STATUS_READABLE);
        perfcounter_csr.rmwf(utra::perfcounter::STATUS_READABLE, bar);
        let mut baz = perfcounter_csr.zf(utra::perfcounter::STATUS_READABLE, bar);
        baz |= perfcounter_csr.ms(utra::perfcounter::STATUS_READABLE, 1);
        perfcounter_csr.wfo(utra::perfcounter::STATUS_READABLE, baz);
        let bar = perfcounter_csr.rf(utra::perfcounter::STATUS_FULL);
        perfcounter_csr.rmwf(utra::perfcounter::STATUS_FULL, bar);
        let mut baz = perfcounter_csr.zf(utra::perfcounter::STATUS_FULL, bar);
        baz |= perfcounter_csr.ms(utra::perfcounter::STATUS_FULL, 1);
        perfcounter_csr.wfo(utra::perfcounter::STATUS_FULL, baz);

        let foo = perfcounter_csr.r(utra::perfcounter::EVENT_INDEX);
        perfcounter_csr.wo(utra::perfcounter::EVENT_INDEX, foo);
        let bar = perfcounter_csr.rf(utra::perfcounter::EVENT_INDEX_INDEX);
        perfcounter_csr.rmwf(utra::perfcounter::EVENT_INDEX_INDEX, bar);
        let mut baz = perfcounter_csr.zf(utra::perfcounter::EVENT_INDEX_INDEX, bar);
        baz |= perfcounter_csr.ms(utra::perfcounter::EVENT_INDEX_INDEX, 1);
        perfcounter_csr.wfo(utra::perfcounter::EVENT_INDEX_INDEX, baz);

        let foo = perfcounter_csr.r(utra::perfcounter::EVENT_RAW1);
        perfcounter_csr.wo(utra::perfcounter::EVENT_RAW1, foo);
        let bar = perfcounter_csr.rf(utra::perfcounter::EVENT_RAW1_TIMESTAMP);
        perfcounter_csr.rmwf(utra::perfcounter::EVENT_RAW1_TIMESTAMP, bar);
        let mut baz = perfcounter_csr.zf(utra::perfcounter::EVENT_RAW1_TIMESTAMP, bar);
        baz |= perfcounter_csr.ms(utra::perfcounter::EVENT_RAW1_TIMESTAMP, 1);
        perfcounter_csr.wfo(utra::perfcounter::EVENT_RAW1_TIMESTAMP, baz);

        let foo = perfcounter_csr.r(utra::perfcounter::EVENT_RAW0);
        perfcounter_csr.wo(utra::perfcounter::EVENT_RAW0, foo);
        let bar = perfcounter_csr.rf(utra::perfcounter::EVENT_RAW0_TIMESTAMP);
        perfcounter_csr.rmwf(utra::perfcounter::EVENT_RAW0_TIMESTAMP, bar);
    ...
    fn compile_check_identifier_mem_csr() {
        ...
        let mut baz =
            identifier_mem_csr.zf(utra::identifier_mem::IDENTIFIER_MEM_IDENTIFIER_MEM, bar);
